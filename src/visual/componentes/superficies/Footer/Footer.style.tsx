...
export const RodapeTitulo = styled(
	(propriedades: TypographyProps<React.ElementType>) => (
...
`;
/* ( . . . ) */
export const BotaoRedeSocial = styled(
	(propriedades: LinkProps<React.ElementType>) => (
		<Link
